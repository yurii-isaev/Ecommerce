  ...
  <div class="container scrollable-container">
    <div class="row">
      <div class="col col-md-5">
        <div class="cart-item-details">
          ...
          <p><strong>Custom Price: </strong>{{ price !== cartItem?.price ? formattedCustomPrice : formattedPrice }}
          </p>
        </div>
      </div>
    ...
    <div class="container">
      <div>
        ...
        <hr>
        <div class="wrap">
          <button class="btn btn-green" type="button" @click="addLayer">Add layer</button>
          <button type="button" class="btn btn-yellow" v-show="hasLayers" data-v-show="hasLayers"
                  @click="updateOrders()">
            Save
          </button>
        </div>
...
<style lang="scss" scoped>
  .scrollable-container {
    overflow: auto;
    max-height: 100vh; /* Ограничение высоты контейнера */
  }
